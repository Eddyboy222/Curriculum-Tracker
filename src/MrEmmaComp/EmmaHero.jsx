      ...
      <div className="bg-white shadow-md w-full max-w-md md:max-w-7xl h-auto rounded-2xl p-6">
        ...
        <div className="flex md:flex-row justify-between md:items-center border-b border-gray-300 pb-4">
          ...
          <div className="text-right md:text-right mt-3 md:mt-0">
            <h1 className="font-bold md:text-3xl text-2xl text-blue-500">
              {percentage}%
            </h1>
            <h2 className="font-normal md:text-base text-sm text-gray-600">
              Complete
            </h2>
          </div>
        </div>
        ...
        <div className="pt-5 space-y-3">
          {topics.map((topic, index) => (
            <div
              key={index}
              className="w-full px-4 py-4 rounded-lg bg-gray-100 border border-gray-300 flex flex-row items-center justify-between"
            >
